              ...
              ? <Widget>[
                  Center(
                    ...
                    child: CircularProgressIndicator(
                      valueColor:
                          AlwaysStoppedAnimation<Color>(Color(0xff2B8D78)),
                    ),
                  ))
                ]
              : <Widget>[
                                ...
                                if (checkEmailAndPassword()) {
                                  ...
                                  showDialog(
                                    ...
                                    builder: (context) => AlertDialog(
                                      title: Center(child: Text('Alert', style: TextStyle(color: Color(0xff38B69A), fontFamily: "PoppinsBold", fontSize: 20),)),
                                      content: Text(
                                          'Email or password is incorrect.', style: TextStyle(fontFamily: "PoppinsMedium"),),
                                      actions: <Widget>[
                                        TextButton(
                                          onPressed: () {
